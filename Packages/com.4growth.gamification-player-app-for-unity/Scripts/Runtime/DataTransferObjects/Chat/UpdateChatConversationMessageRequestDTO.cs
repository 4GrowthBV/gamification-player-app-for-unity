...
{
    /// <summary>
    /// Represents the request body for updating a chat conversation message.
    /// </summary>
    public class UpdateChatConversationMessageRequestDTO
    {
        [JsonProperty("data")]
        ...
        public UpdateChatConversationMessageRequestDTO()
        ...
        private UpdateChatConversationMessageRequestDTO(DataContainer data)
        {
            Data = data;
        }
        ...
        /// <summary>
        /// Creates a request for updating a chat conversation message.
        /// </summary>
        public static UpdateChatConversationMessageRequestDTO Create(
            string role,
            string message,
            Guid chatConversationId)
        {
            ...
            return new UpdateChatConversationMessageRequestDTO(new DataContainer(attributes, relationships));
        }
    }
}
