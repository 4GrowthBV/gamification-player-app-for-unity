...
namespace GamificationPlayer
{
    ...
    {
        public IEnumerator CoDeleteChatConversationMessage(Guid chatConversationMessageId, DeleteChatConversationMessageCallback onReady = null)
        {
            string webRequestString = string.Format("{0}/chat-conversation-messages/{1}", environmentConfig.API_URL, chatConversationMessageId);
