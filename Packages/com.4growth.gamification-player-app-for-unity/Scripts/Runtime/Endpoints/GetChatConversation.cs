...
namespace GamificationPlayer
{
    ...
    {
        public IEnumerator CoGetChatConversation(Guid chatConversationId, GetChatConversationCallback onReady = null)
        {
            ...
            if(environmentConfig.TryGetMockDTO<GetChatConversationResponseDTO>(out var dto))
            {
            ...
            else
            {
                ...
                GetChatConversationResponseDTO obj = null;
                ...
                switch (webRequest.result)
                {
                    ...
                    case UnityWebRequest.Result.Success:
                        ...
                        obj = webRequest.downloadHandler.text.FromJson<GetChatConversationResponseDTO>();
