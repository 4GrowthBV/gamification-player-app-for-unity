...
{
    public class CreateChatConversationMessageRequestDTOTest
    {
        [Test]
        public void TestConstructor()
        {
            ...
            var obj = CreateChatConversationMessageRequestDTO.Create(role, message, chatConversationId);
        ...
        public void TestFromJSON()
        {
            ...
            var json = obj.ToJson();
            var newObj = json.FromJson<CreateChatConversationMessageRequestDTO>();
