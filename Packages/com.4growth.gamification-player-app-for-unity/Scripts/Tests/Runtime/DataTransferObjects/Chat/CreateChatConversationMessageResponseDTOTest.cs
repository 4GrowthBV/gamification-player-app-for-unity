...
{
    public class CreateChatConversationMessageResponseDTOTest
    {
        [Test]
        public void TestDTO()
        {
            ...
            gamificationPlayerEnvironmentConfig.TryGetMockDTO<CreateChatConversationMessageResponseDTO>(out var dto);
