...
{
    public class CreateChatConversationResponseDTOTest
    {
        [Test]
        public void TestDTO()
        {
            ...
            gamificationPlayerEnvironmentConfig.TryGetMockDTO<CreateChatConversationResponseDTO>(out var dto);
            ...
            Assert.AreEqual(dto.data.Type, "chat_conversation");
