...
{
    public class UpdateChatPredefinedMessageResponseDTOTest
    {
        [Test]
        public void TestDTO()
        {
            ...
            gamificationPlayerEnvironmentConfig.TryGetMockDTO<UpdateChatPredefinedMessageResponseDTO>(out var dto);
